...
//            }
//            if (body.isEmpty()) {
//                Snackbar.make(v, "質問を入力をしてください", Snackbar.LENGTH_LONG).show()
//                return
//            }
//
//
...
override fun onClick(v: View) {
    ...
    private fun showChooser() {
       ...
       val chooserIntent = Intent.createChooser(galleryIntent, "画像取得")
    ...
    override fun onComplete(databaseEror: DatabaseError?, databaseReference: DatabaseReference ){
        progressBar.visibility = View.GONE

        if(databaseEror == null) {
            finish()
